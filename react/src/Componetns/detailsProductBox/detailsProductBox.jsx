...
function DetailsProductBox() {
    return (
        <>
        <div className="box text-black-main bg-[#F9F9F9]">
            <img src="./public/images/main/mainProductpage.jpg"  className='w-full' alt="" />
            <div className='pr-3 py-4'>
                            <p className='text-base max-xs:text-xs font-MorabbaMedium'>تیشرت زنانه کد 1737</p>
